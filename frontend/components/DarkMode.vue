<template>
  <div class="dark:bg-[#0F172A]">
    <button @click="toggleColor" class="text-yellow-800 pr-[500px] pt-10 pb-0 transition-all duration-1000 ease-in transform translate-x-10">
      <svg v-if="colorMode.preference === 'light'"
        version="1.0"
        id="Layer_1"
